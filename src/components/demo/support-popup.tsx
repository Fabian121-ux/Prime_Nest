...
export default function SupportPopup({ user, onClose }: SupportPopupProps) {
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <DialogHeader>
                ...
                <DialogDescription className="pt-2">
                    This Prime Nest demo has been a labor of love (and lots of data). If you're finding it useful, a little support goes a long way!
                </DialogDescription>
              </DialogHeader>
              <div className="py-4 text-center bg-muted/50 rounded-lg my-4">
                <p className="font-bold text-lg">🙏 Sub Airtime/Data 🙏</p>
                <p className="font-mono text-xl font-semibold text-primary tracking-widest">09036553377 (MTN)</p>
              </div>
              <DialogFooter className="grid grid-cols-2 gap-2">
                <Button onClick={handleNo} variant="outline">No, maybe later</Button>
          ...
          {popupState === 'confirm_yes' && (
            ...
            >
              ...
              <p className="text-muted-foreground mt-2">Please keep to it ❤️. This popup will now close.</p>
            </motion.div>
          )}
            ...
            >
              ...
              <motion.div
               ...
               <div className="grid grid-cols-2 gap-2 mt-6">
                    <Button variant="outline" onClick={handleLogout}>Proceed to Logout</Button>
