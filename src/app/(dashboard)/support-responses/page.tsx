...
export default function SupportResponsesPage() {
    ...
    const isPageLoading = isUserLoading || isUserDataLoading || isLoading;

    if (!isUserAdmin && !isPageLoading) {
         return (
    ...
    if (error) {
        return (
             <div className="text-center py-12">
                ...
                <p className="mt-2 text-muted-foreground">Could not load support responses.</p>
